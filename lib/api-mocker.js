    ...
    function apiMocker() {
        ...
        return {
            init: function(filepath) {
                var sampleContract = JSON.parse(fs.readFileSync("C:\\workspace\\contracts-campaigns\\GET-campaigns-storefront-banners.contract", 'utf8'));

                routeDefinitions.push({
                    route: sampleContract.uri,
                    statusCode: sampleContract.expect.request.status_code,
                    body: sampleContract.expect.body
                });
